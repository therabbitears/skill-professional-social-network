    ...
    window.onload = function () {
       ...
       // ContentTools.DEFAULT_TOOLS[0].push('blockquote')
        ...
        editor.addEventListener('save', function (regions, calledBy) {
            ...
            payload.append('Title', editor.regions()['article-title'].html());
            payload.append('Description', editor.regions()['article'].html());
            payload.append('FilePath', document.getElementById('FilePath').value);
            payload.append('DraftID', document.getElementById('DraftID').value);
