    ...
    Plugin.prototype = {
        ...
        init: function () {
            ...
            if (this.options.size != 'cover') {
                ...
                var popUp =
               $('<div id="pop-up" class="cover pop-up" data-pop-up-id="' + this.uniqueID + '">' +
                   '  <div class="pop-up-content">' +
                   '    <div class="close"></div>' +
                   '    <div class="pop-up-main-content"></div>' +
                   (hasButtons ? '    <div class="pop-up-footer"></div>' : '') +
            ...
            var closeLink = $('<a href="#close" aria-hidden="true" title="Close" class="pop-up-close-trigger"><span class="screen-reader-text icon icon-remove-g"></span></a>').click(function (e) {
                e.preventDefault();
            ...
            if (isAndroid > 0) {
                ...
                if (options.size != 'cover') {
                    if (windowSize > contentSize) {
                        var contentOffset = 100;// Math.round(windowSize / 2) - Math.round(contentSize / 2);
                ...
                popUpObject.css({ display: "none", visibility: "visible" }).fadeIn(100);
                $('*[data-pop-up-background-id="' + this.uniqueID + '"]').fadeIn(100);
            }
...
function ____clearPopup() {
    $('body').removeClass('modal-open');
    $(".pop-up-background").fadeOut(200, function () { $(".pop-up-background").remove(); });
    $(".pop-up").fadeOut(200, function () { $(".pop-up").remove(); });
}