...
function ____changeProfilePicture($obj) {
    ...
    $.get('/account/changeProfilePicture', function (res) {
        $('<div id="share-cotainer">').popUpWindow({
            action: "open",
            size: "medium"
        });
...
function getAffiliationHistory($obj) {
    ...
    $.ajax({
        ...
        dataType: 'html',
        waitingSelector: $obj.find('.waiting-bg'),
        success: function (response) { $('#affiliation-history').prepend(response); }
    });
}
...
function getBAwardHistory($obj) {
    ...
    $.ajax({
        ...
        dataType: 'html',
        waitingSelector: $obj.find('.waiting-bg'),
        success: function (response) { $('#baward-history').prepend(response); $('button[data-add-baward]').hide(); }
    });
}
...
function getServices($obj) {
    ...
    $.ajax({
        ...
        dataType: 'html',
        waitingSelector: $obj.find('.waiting-bg'),
        success: function (response) { $('#services-list').prepend(response); $('.finding-list .plus-add-profile-item').hide(); }
    });
}
...
function getProducts($obj) {
    ...
    $.ajax({
        ...
        dataType: 'html',
        waitingSelector: $obj.find('.waiting-bg'),
        success: function (response) { $('#product-list').prepend(response); $('.finding-list .plus-add-profile-item').hide(); }
    });
}
